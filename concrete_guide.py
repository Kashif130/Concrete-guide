...
.block-container { padding: 1rem 1.8rem 2.5rem; max-width: 1380px; }
...
.stTabs [aria-selected="true"] {
    ...
    box-shadow: 0 0 16px var(--neon-dim) !important;
}
...
[data-testid="stMetricLabel"] { font-size: 9px !important; letter-spacing: 3px !important; color: var(--text-dim) !important; text-transform: uppercase; }
...
.guide-card:hover { border-color: #2A3D52; }
.guide-card-gold {
    background: linear-gradient(140deg, #0B1019, #110E08);
...
.guide-card-neon {
    background: linear-gradient(140deg, #0B1019, #04110D);
...
.tag-neon { display:inline-block; background:#00FFB210; border:1px solid #00FFB230; color:var(--neon); padding:2px 10px; border-radius:4px; font-size:11px; margin:3px; }
.tag-gold { display:inline-block; background:#EDD97A10; border:1px solid #EDD97A30; color:var(--gold); padding:2px 10px; border-radius:4px; font-size:11px; margin:3px; }
.tag-red  { display:inline-block; background:#FF3D5A10; border:1px solid #FF3D5A30; color:var(--red); padding:2px 10px; border-radius:4px; font-size:11px; margin:3px; }
.tag-blue { display:inline-block; background:#4DA6FF10; border:1px solid #4DA6FF30; color:var(--blue); padding:2px 10px; border-radius:4px; font-size:11px; margin:3px; }
...
.vault-card:hover { border-color: var(--border-glow); }
.warning-box {
    background: #FF3D5A06;
...
<div style="text-align:center; padding: 36px 0 24px;">
    <div style="display:inline-block; background:#00FFB208; border:1px solid #00FFB220; border-radius:16px; padding:6px 20px; margin-bottom:12px;">
        <span style="font-family:'Orbitron',monospace; font-size:10px; color:#00FFB2; letter-spacing:4px;">COMMUNITY GUIDE · ETHEREUM · DEFI</span>
    </div>
    <div style="font-family:'Orbitron',monospace; font-size:44px; font-weight:900; color:#00FFB2; letter-spacing:8px; text-shadow: 0 0 60px #00FFB240; line-height:1.1; margin-bottom:10px;">
        🗿 CONCRETE 101
    </div>
    <div style="font-family:'Inter',sans-serif; font-size:13px; color:#EDD97A; letter-spacing:3px; margin-top:4px; opacity:0.9;">
        {t("THE COMPLETE BEGINNER GUIDE — VAULTS · XP · ROLES · MOAI · BADGES",
           "مکمل ابتدائی گائیڈ — والٹس · XP · رولز · موآئی · بیجز")}
    </div>
    <div style="font-size:11px; color:#252F3A; letter-spacing:2px; margin-top:8px;">
...
tab_labels = [
    ...
    t("🔑 ACCESS ROLES & KEY", "🔑 رولز اور کلید"),
...
tab_start, tab_vaults, tab_roles, tab_xp, tab_moai, tab_articles, tab_tool, tab_write, tab_memes, tab_twitter, tab_faq = tabs
...
with tab_roles:
    ...
    # ── KEY CONDITIONS merged here ──────────────────────────────
    st.markdown("---")
    st.markdown(f"""
    <div style="font-family:'Orbitron',monospace; font-size:13px; color:#556070; letter-spacing:3px; margin:24px 0 16px;">
    🗝️ {t("KEY CONDITIONS — HOW TO UNLOCK A KEY", "کلید کی شرائط — کلید کیسے حاصل کریں")}
    </div>
    """, unsafe_allow_html=True)
...
with tab_articles:
    ...
    article_steps = [
        (t("STEP 1", "مرحلہ 1"),
         ...
         t("Decide what you want to write about — vault guides, DeFi concepts, risk management, or your personal experience with Concrete.",
           "طے کریں کہ کیا لکھنا ہے — والٹ گائیڈ، DeFi تصورات، رسک مینجمنٹ، یا کنکریٹ کے ساتھ اپنا ذاتی تجربہ۔")),
        (t("STEP 2", "مرحلہ 2"),
         t("Pick Topic from Discord #community-news", "Discord #community-news سے موضوع چنیں"),
         t("Browse the #community-news channel on Concrete Discord for trending topics, announcements, or community discussions to base your article on.",
           "اپنے آرٹیکل کی بنیاد کے لیے Concrete Discord پر #community-news چینل میں trending موضوعات، اعلانات یا کمیونٹی مباحث دیکھیں۔")),
        (t("STEP 3", "مرحلہ 3"),
         t("Write the Article — English Only", "آرٹیکل لکھیں — صرف انگریزی"),
         t("Articles are accepted in English only. Use clear, simple language. Add screenshots where helpful. Aim for 300–1000 words with proper headings.",
           "آرٹیکل صرف انگریزی میں قبول ہوتے ہیں۔ واضح، سادہ زبان استعمال کریں۔ جہاں مددگار ہو اسکرین شاٹس شامل کریں۔ مناسب سرخیوں کے ساتھ 300-1000 الفاظ ہدف رکھیں۔")),
        (t("STEP 4", "مرحلہ 4"),
         t("Publish on Medium or X (Twitter)", "Medium یا X (ٹوئٹر) پر شائع کریں"),
         t("Publish your article on Medium (medium.com) or post it as a thread on X/Twitter. Copy the published link — you'll need it for submission.",
           "اپنا آرٹیکل Medium (medium.com) پر شائع کریں یا X/ٹوئٹر پر thread کے طور پر پوسٹ کریں۔ شائع شدہ لنک کاپی کریں — جمع کرانے کے لیے ضرورت ہوگی۔")),
        (t("STEP 5", "مرحلہ 5"),
         t("Submit on Concrete Dashboard", "Concrete Dashboard پر جمع کرائیں"),
         t("Go to the Concrete community dashboard and submit your article link in the designated submission section. Fill in all required fields accurately.",
           "Concrete کمیونٹی dashboard پر جائیں اور مخصوص submission سیکشن میں اپنا آرٹیکل لنک جمع کرائیں۔ تمام ضروری fields درست طریقے سے بھریں۔")),
        (t("STEP 6", "مرحلہ 6"),
         t("Review — Within 7 Days", "جائزہ — 7 دن کے اندر"),
         t("The Concrete team reviews your submission within 7 days. You'll receive a decision on whether your article is approved or needs improvement.",
           "Concrete ٹیم 7 دن کے اندر آپ کی submission کا جائزہ لیتی ہے۔ آپ کو بتایا جائے گا کہ آرٹیکل منظور ہوا یا بہتری کی ضرورت ہے۔")),
        (t("STEP 7", "مرحلہ 7"),
         t("Approved → Receive 400 BAGS! 🎉", "منظور → 400 BAGS ملیں! 🎉"),
         t("If your article is approved, you receive 400 BAGS reward + Writer badge + bonus XP. Your content is now part of the Concrete community knowledge base!",
           "اگر آپ کا آرٹیکل منظور ہو جائے تو 400 BAGS انعام + Writer بیج + بونس XP ملتا ہے۔ آپ کا مواد اب Concrete کمیونٹی علم کا حصہ ہے!")),
    ]
    ...
    st.markdown(f"""
    <div style="background:linear-gradient(135deg,#0C1018,#0A0F08); border:1px solid #00FFB240; border-radius:12px; padding:20px 24px; margin:16px 0; display:flex; align-items:center; gap:20px; flex-wrap:wrap;">
        <div style="font-family:'Orbitron',monospace; font-size:36px; color:#EDD97A; font-weight:900;">400</div>
        <div>
            <div style="font-family:'Orbitron',monospace; font-size:13px; color:#00FFB2; letter-spacing:3px; margin-bottom:4px;">{t("BAGS REWARD PER APPROVED ARTICLE", "ہر منظور شدہ آرٹیکل پر BAGS انعام")}</div>
            <div style="font-size:12px; color:#556070;">{t("+ Writer Badge + Bonus XP + Community Visibility", "+ Writer بیج + بونس XP + کمیونٹی نمائش")}</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div class="guide-card-neon">
        ...
        📣 {t("WHERE TO PUBLISH", "کہاں شائع کریں")}
        </div>
        <div style="display:flex; gap:24px; flex-wrap:wrap; font-size:13px; color:#E8F0F8; line-height:2.0;">
            <div>
                <div style="font-family:'Orbitron',monospace; font-size:11px; color:#EDD97A; margin-bottom:6px;">📰 MEDIUM</div>
                <div style="color:#556070; font-size:12px;">{t("medium.com — publish as article,<br>share the link for submission", "medium.com — آرٹیکل شائع کریں،<br>submission کے لیے لنک شیئر کریں")}</div>
            </div>
            <div style="border-left:1px solid #131B25; padding-left:24px;">
                <div style="font-family:'Orbitron',monospace; font-size:11px; color:#EDD97A; margin-bottom:6px;">🐦 X (TWITTER)</div>
                <div style="color:#556070; font-size:12px;">{t("Post as a thread on X/Twitter,<br>share the thread link for submission", "X/ٹوئٹر پر thread پوسٹ کریں،<br>submission کے لیے thread لنک شیئر کریں")}</div>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
# ════════════════════════════════════════════════════════════════
# TAB 9 — WRITE GUIDE (Article Writing with AI & Manual)
# ════════════════════════════════════════════════════════════════
with tab_write:
    st.markdown(f"""
    <div style="font-family:'Orbitron',monospace; font-size:13px; color:#556070; letter-spacing:3px; margin-bottom:20px;">
